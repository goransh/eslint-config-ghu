...
export function js(): TSESLint.FlatConfig.Config[] {
  return [{
    rules: {
      /**
      ...
      "id-length": ["warn", {min: 2, exceptions: ["i"]}],
       ...
       */
      "no-magic-numbers": "off", // Handle this with typescript-eslint if this is ever enabled
      ...
      "sort-imports": "off", // The eslint-plugin-import handles import sorting
