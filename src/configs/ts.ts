...
export function ts(): TSESLint.FlatConfig.Config[] {
  return config([{
    ...
    rules: {
      ...
      "@typescript-eslint/member-ordering": "off", // Many options here, consider testing this rule
      ...
      "@typescript-eslint/no-deprecated": "off", // Difficult enforce this generally
      // Disallow duplicate class members
      "@typescript-eslint/no-dupe-class-members": "off", // Handled by TS compiler, not recommended anymore
      ...
      "@typescript-eslint/no-invalid-this": "off", // Handled by TS compiler, not recommended anymore
      ...
      "@typescript-eslint/no-redeclare": "off", // Handled by TS compiler, not recommended anymore
      /*
      ...
      "@typescript-eslint/no-restricted-types": "off", // This rule is project specific
      ...
      "@typescript-eslint/no-unnecessary-type-parameters": "off", // Consider testing this rule
      ...
      "@typescript-eslint/no-unsafe-type-assertion": "off", // Difficult to enforce, sometimes this is needed
      ...
      "@typescript-eslint/parameter-properties": "off", // Syntax is fine with formatting and reduces boilerplate code significantly
      // Enforce the use of as const over literal type.
      "@typescript-eslint/prefer-as-const": "warn",
      // Require destructuring from arrays and/or objects.
      "@typescript-eslint/prefer-destructuring": "off", // Leave this to the developer
